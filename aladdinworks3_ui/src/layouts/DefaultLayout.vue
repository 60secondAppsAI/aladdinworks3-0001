...
-->>
				...
				<a-menu-item>
					<router-link to="/powerSwitchs">
						<span class="label">Power Switchs</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/powerMeters">
						<span class="label">Power Meters</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/monitoringSessions">
						<span class="label">Monitoring Sessions</span>
					</router-link>
				</a-menu-item>

    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'coolingCapacity',
          visible: true,
          scopedSlots: { customRender: 'coolingCapacity' },
          sorter: true
          //sorter: (a, b) => a.coolingCapacity - b.coolingCapacity,
          //sorter: (a, b) => a.coolingCapacity.localeCompare(b.coolingCapacity),
        },
        {
          title: 'Efficiency',
		dataIndex: 'efficiency',
          ...
          //sorter: (a, b) => a.efficiency.localeCompare(b.efficiency),
        },
      ],
      pagination: {
        current: 1,

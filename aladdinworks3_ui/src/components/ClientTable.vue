...
export default {
  ...
  methods: {
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-clients',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForClientsChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.clientToAdd.created = currentDate;

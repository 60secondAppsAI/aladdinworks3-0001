    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'inputVoltage',
          visible: true,
          scopedSlots: { customRender: 'inputVoltage' },
          sorter: true
          //sorter: (a, b) => a.inputVoltage - b.inputVoltage,
          //sorter: (a, b) => a.inputVoltage.localeCompare(b.inputVoltage),
        },
        {
          title: 'Output Voltage',
		dataIndex: 'outputVoltage',
          visible: true,
          scopedSlots: { customRender: 'outputVoltage' },
          sorter: true
          //sorter: (a, b) => a.outputVoltage - b.outputVoltage,
          //sorter: (a, b) => a.outputVoltage.localeCompare(b.outputVoltage),
        },
      ],
      pagination: {
        current: 1,

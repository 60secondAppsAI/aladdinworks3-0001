					...
					<tr> 
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Clients = true">Add</base-button>
								              <modal :show.sync="modal2Clients">
								                <template slot="header">
								                  <h5 class="modal-title" id="exampleModalLabel">Add Client</h5>
								                </template>
								                <div>
								                  <form @submit.prevent>
								  <base-input label="ClientId" type="text" placeholder="Enter ClientId" v-model="clientToAdd.clientId"></base-input>
								  <base-input label="Name" type="text" placeholder="Enter Name" v-model="clientToAdd.name"></base-input>
								  <base-input label="ContactInfo" type="text" placeholder="Enter ContactInfo" v-model="clientToAdd.contactInfo"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Client Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ClientId" type="text" placeholder="Enter ClientId" v-model="clientDetails.clientId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="clientDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Contact Info</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactInfo" type="text" placeholder="Enter ContactInfo" v-model="clientDetails.contactInfo"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2Clients = false;

      const jsonData = JSON.stringify(this.clientToAdd);
